...
class CustomColors {
  static const primary = Color(0xFF1564c0); //0xff7f69fc
  static const primaryGradient = CustomColorGradient(
    Color(0xFF1564c0), //0xff6966fb
    Color(0xFF1564c0), //0xff6966fb
  );
  ...
  static const leftMenuSelected =
      Color(0xff2e90f1); // This color is used to highlight when selected
  static const lightGreen = Color(0xff84bf31);
  static final disabled = primary;
  static const grayedout = Color(0x8Affffff);

  static const primaryColor = Color(0xFF1564c0); // 0xFF8069fc
